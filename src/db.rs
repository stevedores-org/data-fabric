...
impl McpTaskRow {
    pub fn into_mcp_task(self) -> models::McpTask {
        models::McpTask {
            id: self.id,
            job_id: self.job_id,
