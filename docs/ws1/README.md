...
- `docs/ws1/WS1A_MODULE_MIGRATION_ASSESSMENT.md` (closes #52): per-module Keep/Adapt/Replace/Drop decisions, D1-vs-Surreal schema mapping, runtime config inventory, and the full middleware inventory.
