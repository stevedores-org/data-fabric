...
## 3. Success Criteria (Test-Driven)
...
## 9. Checklist Before Closing TDD

- [x] Inventory (section 5) completed and recorded.
- [x] All success criteria (section 3) verified and documented (this repo: no Node lockfile/scripts; deploy uses Bun only).
- [x] CONTRIBUTING (or equivalent) updated to Bun-only.
- [x] CI runs on Bun; no npm in critical path.
- [x] Rollback plan (section 7) agreed and branch/tag available.
